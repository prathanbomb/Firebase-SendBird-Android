 ...
 */
class PrivateChannelListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    PrivateChannelListAdapter(Context context) {
        mContext = context;
    ...
    void updateOrInsert(BaseChannel channel) {
        ...
        for (int i = 0; i < mChannelList.size(); i++) {
            if (mChannelList.get(i).getUrl().equals(groupChannel.getUrl())) {
                ...
                notifyDataSetChanged();
                Log.v(PrivateChannelListAdapter.class.getSimpleName(), "Channel replaced.");
                return;
            }
        }
    ...
    private class ChannelHolder extends RecyclerView.ViewHolder {
        ...
        ChannelHolder(View itemView) {
            ...
            topicText = itemView.findViewById(R.id.text_private_channel_list_topic);
            lastMessageText = itemView.findViewById(R.id.text_private_channel_list_message);
            unreadCountText = itemView.findViewById(R.id.text_private_channel_list_unread_count);
            dateText = itemView.findViewById(R.id.text_private_channel_list_date);
            memberCountText = itemView.findViewById(R.id.text_private_channel_list_member_count);
            coverImage = itemView.findViewById(R.id.image_private_channel_list_cover);
