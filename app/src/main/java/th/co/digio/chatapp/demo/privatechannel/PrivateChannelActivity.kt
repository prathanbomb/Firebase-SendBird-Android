...
class PrivateChannelActivity : AppCompatActivity() {
    private var mOnBackPressedListener: PrivateChannelActivity.OnBackPressedListener? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_private_channel)

        val toolbar = findViewById<Toolbar>(R.id.toolbar_private_channel)
        ...
        if (savedInstanceState == null) {
            ...
            val fragment = PrivateChannelListFragment.newInstance()
    ...
    internal fun setOnBackPressedListener(listener: PrivateChannelActivity.OnBackPressedListener) {
