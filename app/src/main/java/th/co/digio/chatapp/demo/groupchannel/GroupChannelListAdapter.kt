...
internal class GroupChannelListAdapter(private val mContext: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private inner class ChannelHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal var topicText: TextView = itemView.findViewById(R.id.text_group_channel_list_topic) as TextView
        internal var lastMessageText: TextView = itemView.findViewById(R.id.text_group_channel_list_message) as TextView
        internal var unreadCountText: TextView = itemView.findViewById(R.id.text_group_channel_list_unread_count) as TextView
        internal var dateText: TextView = itemView.findViewById(R.id.text_group_channel_list_date) as TextView
        internal var memberCountText: TextView = itemView.findViewById(R.id.text_group_channel_list_member_count) as TextView
        internal var coverImage: MultiImageView = itemView.findViewById(R.id.image_group_channel_list_cover) as MultiImageView
        internal var typingIndicatorContainer: LinearLayout

        init {
            coverImage.shape = MultiImageView.Shape.CIRCLE
            typingIndicatorContainer = itemView.findViewById(R.id.container_group_channel_list_typing_indicator) as LinearLayout
        }
