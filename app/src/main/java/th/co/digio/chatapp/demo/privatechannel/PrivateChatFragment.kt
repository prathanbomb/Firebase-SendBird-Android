...
class PrivateChatFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mChannelUrl = if (savedInstanceState != null) {
            ...
            arguments!!.getString(PrivateChannelListFragment.EXTRA_GROUP_CHANNEL_URL)
        }

        Log.d(LOG_TAG, mChannelUrl)

        mChatAdapter = PrivateChatAdapter(activity)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val rootView = inflater.inflate(R.layout.fragment_private_chat, container, false)

        retainInstance = true

        mRootLayout = rootView.findViewById(R.id.layout_private_chat_root)
        mRecyclerView = rootView.findViewById(R.id.recycler_private_chat)

        mCurrentEventLayout = rootView.findViewById(R.id.layout_private_chat_current_event)
        mCurrentEventText = rootView.findViewById(R.id.text_private_chat_current_event)

        mMessageEditText = rootView.findViewById(R.id.edittext_private_chat_message)
        mMessageSendButton = rootView.findViewById(R.id.button_private_chat_send)
        mUploadFileButton = rootView.findViewById(R.id.button_private_chat_upload)
    ...
    private fun refresh() {
        if (mChannel == null) {
            GroupChannel.getChannel(mChannelUrl, GroupChannel.GroupChannelGetHandler { groupChannel, e ->
                ...
                mChatAdapter!!.loadLatestMessages(30, BaseChannel.GetMessagesHandler { list, e -> mChatAdapter!!.markAllMessagesAsRead() })
    ...
    private fun setUpChatListAdapter() {
        mChatAdapter!!.setItemClickListener(object : PrivateChatAdapter.OnItemClickListener {
            override fun onUserMessageItemClick(message: UserMessage) {
                ...
                if (message.customType == PrivateChatAdapter.URL_PREVIEW_CUSTOM_TYPE) {
                    try {
        ...
        mChatAdapter!!.setItemLongClickListener(object : PrivateChatAdapter.OnItemLongClickListener {
    ...
    override fun onAttach(context: Context) {
        ...
        (context as PrivateChannelActivity).setOnBackPressedListener(object : PrivateChannelActivity.OnBackPressedListener {
    ...
    private fun updateActionBarTitle() {
        ...
        if (activity != null) {
            (activity as PrivateChannelActivity).setActionBarTitle(title)
        }
    }
    ...
    private fun sendUserMessage(text: String) {
        ...
        val tempUserMessage = mChannel!!.sendUserMessage(text, null, PRIVATE_MESSAGE, BaseChannel.SendUserMessageHandler { userMessage, e ->
            if (e != null) {
                // Error!
                Log.e(LOG_TAG, e.toString())
                Toast.makeText(
    ...
    companion object {
        ...
        private val LOG_TAG = PrivateChatFragment::class.java.simpleName
        ...
        private const val PRIVATE_MESSAGE = "Private"

        /**
         * To create an instance of this fragment, a Channel URL should be required.
         */
        fun newInstance(channelUrl: String): PrivateChatFragment {
