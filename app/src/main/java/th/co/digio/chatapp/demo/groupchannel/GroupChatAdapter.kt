...
internal class GroupChatAdapter(private var mContext: Context?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private inner class AdminMessageHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val messageText: TextView = itemView.findViewById<View>(R.id.text_group_chat_message) as TextView
        private val dateText: TextView = itemView.findViewById<View>(R.id.text_group_chat_date) as TextView
    ...
    private inner class MyUserMessageHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal var messageText: TextView = itemView.findViewById<View>(R.id.text_group_chat_message) as TextView
        internal var editedText: TextView = itemView.findViewById<View>(R.id.text_group_chat_edited) as TextView
        internal var timeText: TextView = itemView.findViewById<View>(R.id.text_group_chat_time) as TextView
        internal var readReceiptText: TextView = itemView.findViewById<View>(R.id.text_group_chat_read_receipt) as TextView
        internal var dateText: TextView = itemView.findViewById<View>(R.id.text_group_chat_date) as TextView
        internal var urlPreviewContainer: ViewGroup = itemView.findViewById<View>(R.id.url_preview_container) as ViewGroup
        internal var urlPreviewSiteNameText: TextView = itemView.findViewById<View>(R.id.text_url_preview_site_name) as TextView
        internal var urlPreviewTitleText: TextView = itemView.findViewById<View>(R.id.text_url_preview_title) as TextView
        internal var urlPreviewDescriptionText: TextView = itemView.findViewById<View>(R.id.text_url_preview_description) as TextView
        internal var urlPreviewMainImageView: ImageView = itemView.findViewById<View>(R.id.image_url_preview_main) as ImageView
    ...
    private inner class OtherUserMessageHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal var messageText: TextView = itemView.findViewById<View>(R.id.text_group_chat_message) as TextView
        internal var editedText: TextView = itemView.findViewById<View>(R.id.text_group_chat_edited) as TextView
        internal var nicknameText: TextView = itemView.findViewById<View>(R.id.text_group_chat_nickname) as TextView
        internal var timeText: TextView = itemView.findViewById<View>(R.id.text_group_chat_time) as TextView
        internal var readReceiptText: TextView = itemView.findViewById<View>(R.id.text_group_chat_read_receipt) as TextView
        internal var dateText: TextView = itemView.findViewById<View>(R.id.text_group_chat_date) as TextView
        internal var profileImage: ImageView = itemView.findViewById<View>(R.id.image_group_chat_profile) as ImageView
    ...
    private inner class MyFileMessageHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal var fileNameText: TextView = itemView.findViewById<View>(R.id.text_group_chat_file_name) as TextView
        internal var timeText: TextView = itemView.findViewById<View>(R.id.text_group_chat_time) as TextView
        internal var readReceiptText: TextView = itemView.findViewById<View>(R.id.text_group_chat_read_receipt) as TextView
        internal var dateText: TextView = itemView.findViewById<View>(R.id.text_group_chat_date) as TextView
        internal var circleProgressBar: CircleProgressBar = itemView.findViewById<View>(R.id.circle_progress) as CircleProgressBar
    ...
    private inner class MyImageFileMessageHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal var readReceiptText: TextView = itemView.findViewById<View>(R.id.text_group_chat_read_receipt) as TextView
        internal var dateText: TextView = itemView.findViewById<View>(R.id.text_group_chat_date) as TextView
        internal var fileThumbnailImage: ImageView = itemView.findViewById<View>(R.id.image_group_chat_file_thumbnail) as ImageView
        internal var circleProgressBar: CircleProgressBar = itemView.findViewById<View>(R.id.circle_progress) as CircleProgressBar
