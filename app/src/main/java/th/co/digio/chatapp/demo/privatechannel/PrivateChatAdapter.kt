...
internal class PrivateChatAdapter(private var mContext: Context?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private var mItemClickListener: PrivateChatAdapter.OnItemClickListener? = null
    private var mItemLongClickListener: PrivateChatAdapter.OnItemLongClickListener? = null
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        val isFailedMessage: Boolean
        val tempFileMessageUri: Uri?
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        when (message) {
            is UserMessage -> // If the sender is current user
                return if (message.sender.userId == SendBird.getCurrentUser().userId) {
                    VIEW_TYPE_USER_MESSAGE_ME
                } else {
                    VIEW_TYPE_USER_MESSAGE_OTHER
                }
            is FileMessage -> return if (message.type.toLowerCase().startsWith("image")) {
            ...
            is AdminMessage -> return VIEW_TYPE_ADMIN_MESSAGE
            else -> return -1
        }
    ...
    fun setItemLongClickListener(listener: PrivateChatAdapter.OnItemLongClickListener) {
        mItemLongClickListener = listener
    }

    fun setItemClickListener(listener: PrivateChatAdapter.OnItemClickListener) {
    ...
    private inner class MyUserMessageHolder internal constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal var urlPreviewContainer: ViewGroup = itemView.findViewById(R.id.url_preview_container) as ViewGroup
        internal var urlPreviewSiteNameText: TextView = itemView.findViewById(R.id.text_url_preview_site_name) as TextView
        internal var urlPreviewTitleText: TextView = itemView.findViewById(R.id.text_url_preview_title) as TextView
        internal var urlPreviewDescriptionText: TextView = itemView.findViewById(R.id.text_url_preview_description) as TextView
        internal var urlPreviewMainImageView: ImageView = itemView.findViewById(R.id.image_url_preview_main) as ImageView
        internal var padding: View = itemView.findViewById(R.id.view_group_chat_padding)

        internal fun bind(context: Context?, message: UserMessage, channel: GroupChannel?, isContinuous: Boolean, isNewDay: Boolean, isTempMessage: Boolean, isFailedMessage: Boolean, clickListener: PrivateChatAdapter.OnItemClickListener?, longClickListener: PrivateChatAdapter.OnItemLongClickListener?, position: Int) {
            messageText.text = message.message
    ...
    private inner class OtherUserMessageHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal fun bind(context: Context?, message: UserMessage, channel: GroupChannel?, isNewDay: Boolean, isContinuous: Boolean, clickListener: PrivateChatAdapter.OnItemClickListener?, longClickListener: PrivateChatAdapter.OnItemLongClickListener?, position: Int) {
    ...
    private inner class MyFileMessageHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal var fileNameText: TextView = itemView.findViewById(R.id.text_group_chat_file_name) as TextView
        internal var timeText: TextView = itemView.findViewById(R.id.text_group_chat_time) as TextView
        internal var readReceiptText: TextView = itemView.findViewById(R.id.text_group_chat_read_receipt) as TextView
        internal var dateText: TextView = itemView.findViewById(R.id.text_group_chat_date) as TextView
        internal var circleProgressBar: CircleProgressBar = itemView.findViewById(R.id.circle_progress) as CircleProgressBar

        internal fun bind(context: Context?, message: FileMessage, channel: GroupChannel?, isNewDay: Boolean, isTempMessage: Boolean, isFailedMessage: Boolean, tempFileMessageUri: Uri?, listener: PrivateChatAdapter.OnItemClickListener?) {
    ...
    private inner class OtherFileMessageHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal fun bind(context: Context?, message: FileMessage, channel: GroupChannel?, isNewDay: Boolean, isContinuous: Boolean, listener: PrivateChatAdapter.OnItemClickListener?) {
            fileNameText.text = message.name
            timeText.text = DateUtils.formatTime(message.createdAt)
    ...
    private inner class MyImageFileMessageHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        internal var readReceiptText: TextView = itemView.findViewById(R.id.text_group_chat_read_receipt) as TextView
        internal var dateText: TextView = itemView.findViewById(R.id.text_group_chat_date) as TextView
        internal var fileThumbnailImage: ImageView = itemView.findViewById(R.id.image_group_chat_file_thumbnail) as ImageView
        internal var circleProgressBar: CircleProgressBar = itemView.findViewById(R.id.circle_progress) as CircleProgressBar
